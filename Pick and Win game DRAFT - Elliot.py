...
# Score augmentation if input matches correct answer:
        ...
        if user_answer in correct_choices:
            ...
            print("Aww, what a shame. That wasn't the correct answer, You got 0 points") (name)! You got 10 points!!")
            score += 0
...
else if resp2 == "N" and resp2 == "n" and resp2 == "No" and resp == "NO":
...
# Not sure how to return to last entered round, as I had issues with coding how to choose the number of rounds - see earlier comment please
